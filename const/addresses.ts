...
let ADDRESS_VERSION: Version = (() => {
  if (typeof window !== 'undefined') {
    const storedVersion = localStorage.getItem('ADDRESS_VERSION') as Version;
    return storedVersion === 'V1' || storedVersion === 'V2' ? storedVersion : 'V1';
  }
  return 'V1';
})();
...
export const getToolsAddress = () => versionAddresses[ADDRESS_VERSION].TOOLS_ADDRESS;
export const getRewardsAddress = () => versionAddresses[ADDRESS_VERSION].REWARDS_ADDRESS;
export const getStakingAddress = () => versionAddresses[ADDRESS_VERSION].STAKING_ADDRESS;
