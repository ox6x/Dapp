    ...
    return (
        <Container maxW={"1200px"}>
            <Flex direction={"column"} alignItems={"center"} justifyContent={"center"} h={"50vh"}>
                <Heading>Claim your exclusive NFT Passport to start mining, earning rewards, and exploring the Crypto Farm ecosystem.</Heading>
                ...
                >Claim Your NFT Passport</Web3Button>
            </Flex>
        </Container>
    );
}
